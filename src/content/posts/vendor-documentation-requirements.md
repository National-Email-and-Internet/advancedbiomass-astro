...
description: "Vendor Documentation Vendor documentation is required for equipment purchased as part of a project.  It is very important information to have, if the equipment "
pubDate: "2016-10-01"
...
![read-operators-manual-notice-sign-s-9890](/images/read-operators-manual-notice-sign-s-9890-300x156.png)Upon completion of fabrication, the manufacturer shall provide to the Owner (x) sets of OEM data for each piece of equipment.  The data shall include all items listed in the Vendor’s equipment components list or bill of material.
