...
Softwood Mix: Spruce, Pine Fir

Basic Wood Density (bone dry)
...
2.70; solid wood to loose chips

Chip Type

Residual chips or from whole logs

Bulk Density (wet)

14.8 – 17.8 lb/ft³ (238 – 286 kg/m³)
...
Decomposing biomass produces harmful gases including CO, CO2 and CH4.

1.  CO and CO2 gas levels can be indicative of smouldering biomass, so measure and trend these gas levels when chips are stored in enclosed vessels and silos.
...
4.  Where there is the possibility of CO, CO2 and CH4 generation, it is also necessary to measure O2 levels in adjacent enclosed areas, for personnel protection.
